...
(function () {
  ...
  const workTimer = {
    ...
    start() {
      const breakAlert = new Audio("https://raw.githubusercontent.com/ptran0089/Pomodoro-Clock/tree/master/js/sound/break.wav");
  ...
  const breakTimer = {
    ...
    start() {
      ...
      const workAlert = new Audio("https://raw.githubusercontent.com/ptran0089/Pomodoro-Clock/tree/master/js/sound/work.wav");
